#!/bin/bash
#SBATCH --job-name=fastwan-vsa-sp-speed
#SBATCH --partition=gpu
#SBATCH --gres=gpu:h100-96:2
#SBATCH --cpus-per-task=16
#SBATCH --mem=192G
#SBATCH --time=04:00:00
#SBATCH --output=fastwan-vsa-sp-speed-%j.out

set -euo pipefail

source "$HOME/cp4101/sglang/slurm/common.sh"

OUTPUT_DIR="$SCRATCH/sglang/outputs/week4/vsa/fastwan_t2v_sp_speedup"
RUN_PREFIX="fastwan_t2v_vsa_sp_speedup_${SLURM_JOB_ID:-manual}"
