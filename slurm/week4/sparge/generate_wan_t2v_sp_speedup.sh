#!/bin/bash
#SBATCH --job-name=wan-t2v-sparge-sp-speed
#SBATCH --partition=gpu
#SBATCH --gres=gpu:h100-96:2
#SBATCH --cpus-per-task=16
#SBATCH --mem=192G
#SBATCH --time=06:00:00
#SBATCH --output=wan-t2v-sparge-sp-speed-%j.out

set -euo pipefail

source "$HOME/cp4101/sglang/slurm/common.sh"

OUTPUT_DIR="$SCRATCH/sglang/outputs/week4/sparge/wan_t2v_sp_speedup"
RUN_PREFIX="wan_t2v_sparge_sp_speedup_${SLURM_JOB_ID:-manual}"
