...
DIST_IFACE=${DIST_IFACE:-ens6f0np0,ens6f1np1}
export GLOO_SOCKET_IFNAME=${GLOO_SOCKET_IFNAME:-"$DIST_IFACE"}
export NCCL_SOCKET_IFNAME=${NCCL_SOCKET_IFNAME:-"$DIST_IFACE"}
