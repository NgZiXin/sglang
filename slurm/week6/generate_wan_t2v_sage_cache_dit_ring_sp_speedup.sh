#!/bin/bash
#SBATCH --job-name=wan-t2v-sage-cache-dit-ring
#SBATCH --partition=gpu
#SBATCH --gres=gpu:h100-96:2
#SBATCH --cpus-per-task=16
#SBATCH --mem=192G
#SBATCH --time=2:00:00
#SBATCH --output=wan-t2v-sage-cache-dit-ring-%j.out

set -euo pipefail

source "$HOME/cp4101/sglang/slurm/common.sh"

OUTPUT_DIR="$SCRATCH/sglang/outputs/week6/sage_cache_dit_ring"
RUN_PREFIX="wan_t2v_sage_cache_dit_ring_sp_speedup_${SLURM_JOB_ID:-manual}"
